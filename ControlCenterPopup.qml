...
Item {
    ...
    PopupWindow {
        ...
        Rectangle {
            ...
            scale: root.bar.controlCenterOpen ? 1 : 0.93
            ...
            Behavior on y { SpringAnimation { spring: 3.8; damping: 0.40; epsilon: 0.16 } }
            Behavior on opacity { NumberAnimation { duration: Math.max(120, root.bar.popupAnimationMs - 50); easing.type: Easing.OutCubic } }
            Behavior on scale { SpringAnimation { spring: 4.0; damping: 0.42; epsilon: 0.001 } }
